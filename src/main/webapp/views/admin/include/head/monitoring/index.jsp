...
<link rel="stylesheet" href="/resources/css/monitoring/monitoring.css"> 
...
<script src="/resources/js/ng-flow-standalone.min.js"></script>
<script src="/resources/js/angular-sanitize.min.js"></script>
<script type="text/javascript" src="/resources/js/admin.js"></script>
<script src="/resources/js/monitoring/index.js" type="text/javascript"></script>